  ...
  @csrf
    ...
    @csrf
      ...
      <div class="input-container">
        ...
        <x-text-input id="name" placeholder="Username" class="icon-input" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        <x-input-error :messages="$errors->get('name')" class="mt-2" />      </div>
      <div class="input-container">
        <img src="assets/images/mail.png" class="icon" alt="">
        <x-text-input id="email" placeholder="Email" class="icon-input" type="email" name="email" :value="old('email')" required autocomplete="username" />
        <x-input-error :messages="$errors->get('email')" class="mt-2" />      </div>
      <div class="input-container">
        <img src="assets/images/lock.png" class="icon" alt="">
        <x-text-input id="password" placeholder="Username" placeholder="Password" class="icon-input"
        type="password"
        name="password"
        minlength="8" 
      ...
      <div class="input-container">
        <img src="assets/images/lock.png" class="icon" alt="">
        <x-text-input id="password_confirmation" placeholder="Confirm Password" class="icon-input"
        type="password"
        minlength="8" 
