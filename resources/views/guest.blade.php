            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse main-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link pr0" href="login" id="loginLink">SIGN IN</a></li>
            ...
            <div class="hero-content h-100">
                <div class="d-table">
                    <div class="d-table-cell">
                        ...
                        <a href="exguest" style="border-color: goldenrod;" class="button smooth-scroll">Explore Now</a>
                    </div>
                </div>
            </div>
        </div>
