		...
		<div class="container">
				...
				<form action="{{ route('register') }}" method="POST" id="registerForm" class="form" style="display: none;">
						...
						<div class="input-container">
								...
								<input type="text" class="icon-input" placeholder="Username" id="name" name="username" required>
						</div>
						<div class="input-container">
								{{-- <img src="assets/images/user.png" class="icon" alt=""> --}}
						...
						<div class="input-container">
								<img src="assets/images/lock.png" class="icon" alt="">
								<input type="password" class="icon-input" placeholder="Confirm Password" id="confirmPassword"
