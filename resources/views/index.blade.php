...
<body data-spy="scroll" data-target=".navbar-nav">
		...
		<header id="header" class="header">
				<!-- ====== Navbar ====== -->
				<nav class="navbar-expand-lg fixed-top navbar">
						<div class="container">
								<!-- Logo -->
                    ...
                    <img src="assets/images/artdex.png" alt="logo">
								...
								<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
										aria-expanded="false"><span><i class="fa fa-bars"></i></span></button>
								<!-- Mobile Menu -->

								<div class="navbar-collapse main-menu collapse" id="navbarSupportedContent">
								...
								<div class="row" id="pricingrow">
										...
										<div class="col-lg-6 col-md-6">
												<div class="single-price-box text-center">
														...
														<button style="background-color: transparent;border:none;" id="bt" type="button"
																class="button" data-toggle="modal" data-target="#exampleModalCenter">
										...
										<div class="col-lg-6 col-md-6">
												<div class="single-price-box text-center" id="premiumbos">
														...
														<button type="button" id="bt" class="button" data-toggle="modal"
