								...
								success: function(data) {
										...
										for (let i = 0; i < data.length; i++) {
												if (data[i].roles == 'TEACHER') {
														...
														if (noteach == 0) {
																searchResultAjax +=
																		'<a class="list-group-item list-group-item-action disabled" id="list-me"><small> Teacher</small></a>'
																// searchResultAjax +='<div class="search-header">Doctors</div>'
																noteach++;
														}
														searchResultAjax += '<a href="' + routes + '" class="list-group-item list-group-item-action">' +
																data[i].name + '</a>'
